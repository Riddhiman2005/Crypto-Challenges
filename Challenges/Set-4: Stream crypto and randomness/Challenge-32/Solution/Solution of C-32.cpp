...
void hmacsha1(const char* filename, int len, uint8_t* res, uint8_t* k) {
  // Implementation of HMAC-SHA1 is not provided
  //Replace this function with your own implementation
  
  
  std::cout << "HMAC-SHA1 function not implemented!" << std::endl;
}
